...
const Services = () => {
  ...
  const services = [
    { title: t("fileComplaints"), description: t("fileComplaintsDesc") },
    { title: t("trackStatus"), description: t("trackStatusDesc") },
    { title: t("getSupport"), description: t("getSupportDesc") },
    { title: t("reportIssues"), description: t("reportIssuesDesc") },
  ];
