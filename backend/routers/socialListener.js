...
router.get("/complaints", async (req, res) => {
  try {
    ...
    const payload = items.map((g) => ({
      ...
      isValidComplaint: typeof g.isValidComplaint === "boolean" ? g.isValidComplaint : null,
      aiClassification: g.aiClassification || "UNCLASSIFIED",
      aiConfidence: typeof g.aiConfidence === "number" ? g.aiConfidence : 0,
      aiClassificationReason: g.aiClassificationReason || "",
